...
with open("results/doubt_experiments/20260129_040926_results.json", "r") as f:
    data = json.load(f)

hist = data["doubt_model_results"]["42"][0]["loss_history"]
...
for i, entry in enumerate(hist):
    ...
    if perplexity is not None and perplexity < 2.0:
        print(f"Step {step}: perplexity={perplexity}, eval_loss={eval_loss}, avg_eval_loss={avg_eval_loss}")
        # print full entry
        # break
