...
def diagnostic_benchmark():
    ...
    assess_cubic_feature_contributions(
        input_dim, output_dim, n_epochs, X, test_poly_rank
    )
...
def evaluate_rank_scaling(input_dim, output_dim, n_epochs, make_rank_k_target, X):
    print("\n" + "-" * 90)
...
def check_true_capacity():
    ...
    models = {
        ...
        "DendriticStack": DendriticStack(
            d, 1, poly_rank=16
        ),  # Quadratic + GELU + Quadratic
    }
