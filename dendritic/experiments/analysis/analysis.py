...
def print_experiment_summary(results: ExperimentResults) -> None:
    ...
    # Special case labels
    label_map = {"stack": "Dendritic Stack:", "baseline_wave": "Baseline Wave:"}
    ...
    def print_comparison(name, comp):
        ...
        print(
            f"Paired t-test: t = {comp['paired_ttest']['t_statistic']:6.3f}, p = {comp['paired_ttest']['p_value']:6.4f}"
        )
...
def analyze_results(model_results: dict[str, list[TrainingResult]]) -> dict[str, Any]:
    ...
    for model_name, results in model_results.items():
        ...
        model_metrics[model_name] = {"final_ppl": final_ppl, "best_ppl": best_ppl}
        ...
        for model2 in model_metrics.keys():
            if "baseline" != model2:
                ...
                analysis[analysis_key] = {
                    ...
                    "ppl_improvement_pct": 100 * (mean1 - mean2) / mean1
                    if mean1 != 0
                    else 0.0,
